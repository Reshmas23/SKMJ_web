...
class TermsAndConditions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      1.SKMJ Higher Secondary School Kalpetta - The Tution/School App, all of its forms, whether it be featured on any of SKMJ Higher Secondary School Kalpetta
      mobile application or on the www.SKMJ Higher Secondary School Kalpetta.com online website services (“App”), is
      a product of SKMJ Higher Secondary School Kalpetta Tution/School Centre.
     
      
      2.By using the SKMJ Higher Secondary School Kalpetta - The Tution/School App services, you are agreeing to be bound
      by the following terms and conditions.

      
      3.SKMJ Higher Secondary School Kalpetta reserves the right to update and change the terms and conditions that apply to
      ...
      organization that is the intended party requesting service from the App of SKMJ Higher Secondary School Kalpetta.

      
      5.Any App offer made by SKMJ Higher Secondary School Kalpetta is limited to the duration advertised or in the absence
      of such time or in the event of any error or omission shall be valid for 24 hours from
      when it first appeared unless SKMJ Higher Secondary School Kalpetta in its sole discretion decides to change the extent
      or duration of any offer.

      
      6.Any reference to a sum charged by SKMJ Higher Secondary School Kalpetta is in Indian Currency (INR) unless
      ...
      right is proven to be stronger, SKMJ Higher Secondary School Kalpetta reserves the right to remove the application
      from its systems, or alter the Agreement to be with the proper right holder instead. No
      refund will be issued.

      
      9.SKMJ Higher Secondary School Kalpetta will use reasonable efforts to have the App approved by the Apple Store and
      ...
      12.SKMJ Higher Secondary School Kalpetta warrants that the App service shall be performed with reasonable care in a
      diligent and competent manner. To the fullest extent permitted by law, this clause is
      SKMJ Higher Secondary School Kalpetta’s only warranty concerning the services and is made expressly in lieu of all
      ...
      13.SKMJ Higher Secondary School Kalpetta may issue an update to the Client’s App which may add, modify and/or
      remove app features. These updates may be pushed out automatically without notice,
      although SKMJ Higher Secondary School Kalpetta intends to notify the Client in advance of an upcoming update with
      details on what the update includes.

      
      14.SKMJ Higher Secondary School Kalpetta warrants that the GPS and Biometric devices (“Hardware”) provided if any, is
      ...
      15.SKMJ Higher Secondary School Kalpetta does not warrant and is not responsible for any products or services, including
      delivery of messages by carriers, on other networks or on other providers systems or
      infrastructure which is beyond the best efforts of SKMJ Higher Secondary School Kalpetta, which it is accepted to have
      been made by SKMJ Higher Secondary School Kalpetta on its own systems.

      
      16.SKMJ Higher Secondary School Kalpetta does not warrant to any client the benefit of App or services that any client
      shall acquire from SKMJ Higher Secondary School Kalpetta.

      
      17.The Client warrants that it has not relied on any representations in writing or
      otherwise by App or SKMJ Higher Secondary School Kalpetta and that it is bound by these terms and conditions as a
      precondition of doing business with SKMJ Higher Secondary School Kalpetta which it accepts by making any payment
      to SKMJ Higher Secondary School Kalpetta or requests for its products or services.
      ...
      19.Where SKMJ Higher Secondary School Kalpetta should incur any additional charges for any in app purchases, SKMJ Higher Secondary School Kalpetta
      ...
      and SKMJ Higher Secondary School Kalpetta prior to providing the services unless agreed otherwise.

      
      21.SKMJ Higher Secondary School Kalpetta reserves the right to terminate the service for any reason by giving 30 days’
      ...
      to pay, SKMJ Higher Secondary School Kalpetta reserves the right to charge a reactivation fee if The Client requests
      that the service be reactivated and SKMJ Higher Secondary School Kalpetta were to agree to reactivate it.

      
      22.In no event shall the total aggregate liability of SKMJ Higher Secondary School Kalpetta extend 50% of the Annual fees
      ...
      of the services remain the property of SKMJ Higher Secondary School Kalpetta.
      ...
      by SKMJ Higher Secondary School Kalpetta.

     
      25.In the event of service termination, the Client agrees that SKMJ Higher Secondary School Kalpetta has the right to
      ...
      the Client shall use belong to SKMJ Higher Secondary School Kalpetta. The Client obtains no rights to this intellectual
      ...
      under copyright laws, the Client agrees to indemnify SKMJ Higher Secondary School Kalpetta for any infringement on
      such copyright.

      
      28.The Client indemnifies SKMJ Higher Secondary School Kalpetta from and against all losses, any claim, demand, action,
      ...
      SKMJ Higher Secondary School Kalpetta’s services.
      ...
      31.SKMJ Higher Secondary School Kalpetta is permitted to assign or license its associated services to any third party
      ...
      33.SKMJ Higher Secondary School Kalpetta will not accept responsibility for any server down time, server delayed
      ...
      imply that it is associated with App or SKMJ Higher Secondary School Kalpetta.

      
      35.SKMJ Higher Secondary School Kalpetta expressly makes NO claim or representation that:
      ...
      36.SKMJ Higher Secondary School Kalpetta will not under any circumstances accept liability for any damages or losses
      ...
      37.SKMJ Higher Secondary School Kalpetta will not accept liability for any damages for loss of business or loss of profits
      ...
      liability by SKMJ Higher Secondary School Kalpetta shall apply whether it otherwise would arise pursuant to contract
      ...
      38.Force Majeure shall apply to this relationship between SKMJ Higher Secondary School Kalpetta and the party receiving
      ...
      restrictions or other causes beyond the control of SKMJ Higher Secondary School Kalpetta it is unable to perform in
      whole or in part its obligations as set forth in this Agreement, then SKMJ Higher Secondary School Kalpetta shall be
     
      relieved of those obligations to the extent it is so unable to perform its services and
      shall not make SKMJ Higher Secondary School Kalpetta liable to any affected party.
      ...
      right of not facilitating services at the discretion of SKMJ Higher Secondary School Kalpetta without being required to
      give reason for same.

      
      42.In the event that SKMJ Higher Secondary School Kalpetta were to delay any right of action arising pursuant to these
      terms and conditions, any updated changes to these terms and conditions or arising
      from its contractual rights or in tort it shall not give rise to any waiver by SKMJ Higher Secondary School Kalpetta to
