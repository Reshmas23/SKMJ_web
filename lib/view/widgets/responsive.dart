...
class ResponsiveWebSite extends StatelessWidget {
  ...
  const ResponsiveWebSite(
      {required this.mobile, required this.tablet, required this.desktop, super.key});
  ...
  static bool isTablet(BuildContext context) {
    return MediaQuery.of(context).size.width < 1100 && MediaQuery.of(context).size.width >= 650;
  }
