...
class ParentModel {
  ...
  @override
  String toString() {
    return 'ParentModel(parentName: $parentName, docid: $docid, createdate: $createdate, parentPhoneNumber: $parentPhoneNumber, parentEmail: $parentEmail, password: $password, studentID: $studentID, houseName: $houseName, place: $place, state: $state, pincode: $pincode, district: $district, gender: $gender, profileImageID: $profileImageID, profileImageURL: $profileImageURL, userRole: $userRole)';
  }
